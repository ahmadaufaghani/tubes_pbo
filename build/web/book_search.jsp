<%-- 
    ...
    Created on : 12 Jun 2025, 21.46.50
    Author     : bamba
--%>
...
<head>
    ...
    <title>Search : <%= request.getParameter("key") %> | e-book</title>
    ...
    <div class="content">
        <form method="get" action="BukuController?">
            <div class="search underline">
                <input class="search-box" type="text" name="key" placeholder="Find the book that you like here" value="<%= request.getParameter("key") %>">
                <input class="btn btn-search" type="submit" value="Search">
            </div>
        </form>
        <div class="content-header-edited-1">
           <h1 class="content-header-title"><%= request.getAttribute("content-title")%></h1>
           <p class="content-header-desc"><%= request.getAttribute("content-desc")%></p>
        </div>
        <div>
